        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Sale Detail</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Struk: {{ $data->no_struk }}</h6>
            </nav>
        </div>
    </nav>
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex justify-content-between">
                        <h6>Sale Receipt</h6>
                        <div>
                            <button onclick="window.print()" class="btn btn-dark btn-sm me-2">Print</button>
                            <a href="{{ route('sale.index') }}" class="btn btn-secondary btn-sm">Back</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <p class="text-sm mb-0 text-secondary">No. Struk</p>
                                <h6 class="text-sm font-weight-bold">{{ $data->no_struk }}</h6>
                            </div>
                            <div class="col-md-6">
                                <p class="text-sm mb-0 text-secondary">Date & Time</p>
                                <h6 class="text-sm font-weight-bold">{{ $data->tgl_jual }}</h6>
                            </div>
                        </div>
