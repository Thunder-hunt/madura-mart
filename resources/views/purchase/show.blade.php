        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Purchase Detail</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Nota: {{ $data->no_nota }}</h6>
            </nav>
        </div>
    </nav>
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex justify-content-between">
                        ...
                        <a href="{{ route('purchase.index') }}" class="btn btn-secondary btn-sm">Back</a>
                    </div>
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col-md-4">
                                <p class="text-sm mb-0 text-secondary">No. Nota</p>
                                <h6 class="text-sm font-weight-bold">{{ $data->no_nota }}</h6>
                            </div>
                            <div class="col-md-4">
                                <p class="text-sm mb-0 text-secondary">Date</p>
                                <h6 class="text-sm font-weight-bold">{{ $data->tgl_nota }}</h6>
                            </div>
                            <div class="col-md-4">
                                <p class="text-sm mb-0 text-secondary">Distributor</p>
                                <h6 class="text-sm font-weight-bold">{{ $data->distributor->name_distributor ?? 'N/A' }}</h6>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    @foreach($data->details as $item)
                                        <tr>
                                            ...
                                            <td class="p-3 text-sm font-weight-bold">Rp {{ number_format($item->harga_beli, 0, ',', '.') }}</td>
                                            <td class="p-3 text-sm font-weight-bold">{{ $item->jumlah_beli }}</td>
