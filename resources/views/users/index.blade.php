            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                        <h6>{{ $title }} Data</h6>
                        <a href="{{ route('users.create') }}" class="btn btn-primary btn-sm mb-0"> Add New {{ $title }}</a>
                    </div>
                            ...
                            <table class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-primary text-xs font-weight-bolder opacity-7">Role</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($datas as $nmr => $data)
                                        <tr>
                                            ...
                                            <td class="text-xs font-weight-bold mb-0">
                                                <span class="badge badge-sm bg-gradient-{{ $data->role === 'admin' ? 'success' : 'secondary' }}">
                                                    {{ ucfirst($data->role) }}
                                                </span>
                                            </td>
                                        </tr>
